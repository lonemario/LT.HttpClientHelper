...
namespace LT.HttpClientHelper
{
    public interface IMainHttpClient
    {
        ...
        Task<HttpResponseMessage> InvokeBase(string partialUrl, HttpMethod method, AuthenticationHeaderValue authentication = null, string acceptedResponseType = null, Encoding encodingType = null, string contentMediaType = null);
        HttpResponseMessage InvokeBaseSync(string partialUrl, HttpMethod method, AuthenticationHeaderValue authentication = null, string acceptedResponseType = null, Encoding encodingType = null, string contentMediaType = null);
